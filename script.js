document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(() => {
                        showSuccessMessage(contactForm, 'Message sent successfully!');
                        contactForm.reset();
        ...
        function showSuccessMessage(form, message) {
            ...
            successDiv.style.cssText = 'background: #d4edda; color: #155724; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '325dba35-8b24-49c4-8a34-4e61852b6751',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '325dba35-8b24-49c4-8a34-4e61852b6751';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '325dba35-8b24-49c4-8a34-4e61852b6751';
